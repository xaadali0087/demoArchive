...
// import useWalletConnectTransaction from "./useWalletConnectTransaction";

// interface WalletConnectScreenProps {}

// const WalletConnectScreen: FC<WalletConnectScreenProps> = ({}) => {
...
//         <div>
//           {/* <w3m-account-button /> */}
//           <p>Want to disconnect the wallet?</p>
//           <button
//             className="py-3 px-5 bg-primary-500 rounded-xl font-semibold text-white"
